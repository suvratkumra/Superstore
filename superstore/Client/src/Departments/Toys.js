...
export default function Toys() {
  ...
  const initializeNumber = {Kid_Connection_Music_Keyboard:0, Play_Doh_Drill_n_Fill_Dentist_Toy:0, Mattel_Hot_Wheels_5_Car_Pack_Assortment:0, Kid_Connection_Utility_Trucks_Toy:0, Mattel_Hot_Wheels_Vehicles:0, Pressman_Shark_Bite_Game:0, Regent_Soccerball:0, Size_3T_Paw_Patrol:0, Spark_Wooden_Puzzle_Set:0, Barbie_Pop_Star_Doll:0, Munchkin_Duck_Dunk_Bath_Toy:0, Mattel_Kerplunk:0, PlayMonster_Things:0, Play_Day_Play_Balls:0, Playmobil_School_Bus_Playset:0};
              ...
              cartText.Kid_Connection_Music_Keyboard ? <div className = 'increment__container'> 
                                      <button className = 'minus' onClick = {() => {
                                                                                    if(itemIncrementer.Kid_Connection_Music_Keyboard > 0)
                                                                                      ...
                                                                                      addToCartListener("Music Keyboard", itemIncrementer.Kid_Connection_Music_Keyboard, 25.99);                                                                          

                                                                                    } }> - </button>
                                      <span className = 'number'> {itemIncrementer.Kid_Connection_Music_Keyboard} </span>
                                      <button className = 'plus' onClick = {() => {setItemIncrementer({...itemIncrementer, Kid_Connection_Music_Keyboard: itemIncrementer.Kid_Connection_Music_Keyboard+1});
                                                                                  addToCartListener("Music Keyboard", itemIncrementer.Kid_Connection_Music_Keyboard, 25.99);                                                                          
                                      }}> + </button>                                    
                                     </div> 
              ...
              cartText.Play_Doh_Drill_n_Fill_Dentist_Toy ? <div className = 'increment__container'> 
                                      <button className = 'minus' onClick = {() => {
                                                                                    if(itemIncrementer.Play_Doh_Drill_n_Fill_Dentist_Toy > 0)
                                                                                      ...
                                                                                      addToCartListener("Drill'n Fill Dentist Toy", itemIncrementer.Play_Doh_Drill_n_Fill_Dentist_Toy, 11.99);                                                                          
                                                                                    } }> - </button>
                                      <span className = 'number'> {itemIncrementer.Play_Doh_Drill_n_Fill_Dentist_Toy} </span>
                                      <button className = 'plus' onClick = {() => {setItemIncrementer({...itemIncrementer, Play_Doh_Drill_n_Fill_Dentist_Toy: itemIncrementer.Play_Doh_Drill_n_Fill_Dentist_Toy+1});
                                                                                  addToCartListener("Drill'n Fill Dentist Toy", itemIncrementer.Play_Doh_Drill_n_Fill_Dentist_Toy, 11.99);                                                                          
                                       } }> + </button>                                    
                                     </div> 
                                     : <span className = 'add_to_cart__name'> Add to Cart </span>
              ...
              cartText.Mattel_Hot_Wheels_5_Car_Pack_Assortment ? <div className = 'increment__container'> 
                                      <button className = 'minus' onClick = {() => {
                                                                                    if(itemIncrementer.Mattel_Hot_Wheels_5_Car_Pack_Assortment > 0)
                                                                                      ...
                                                                                      addToCartListener("5 Car Pack Assortment", itemIncrementer.Mattel_Hot_Wheels_5_Car_Pack_Assortment, 5.99);                                                                          
                                                                                    } }> - </button>
                                      <span className = 'number'> {itemIncrementer.Mattel_Hot_Wheels_5_Car_Pack_Assortment} </span>
                                      <button className = 'plus' onClick = {() => {setItemIncrementer({...itemIncrementer, Mattel_Hot_Wheels_5_Car_Pack_Assortment: itemIncrementer.Mattel_Hot_Wheels_5_Car_Pack_Assortment+1});
                                                                                  addToCartListener("5 Car Pack Assortment", itemIncrementer.Mattel_Hot_Wheels_5_Car_Pack_Assortment, 5.99);                                                                          
                                      }}> + </button>                                    
                                     </div> 
                                     : <span className = 'add_to_cart__name'> Add to Cart </span>
              ...
              cartText.Kid_Connection_Utility_Trucks_Toy ? <div className = 'increment__container'> 
                                      <button className = 'minus' onClick = {() => {
                                                                                    if(itemIncrementer.Kid_Connection_Utility_Trucks_Toy > 0)
                                                                                      ...
                                                                                      addToCartListener("Utility Trucks Toy", itemIncrementer.Kid_Connection_Utility_Trucks_Toy, 9.99);                                                                          
                                                                                    } }> - </button>
                                      <span className = 'number'> {itemIncrementer.Kid_Connection_Utility_Trucks_Toy} </span>
                                      <button className = 'plus' onClick = {() => {setItemIncrementer({...itemIncrementer, Kid_Connection_Utility_Trucks_Toy: itemIncrementer.Kid_Connection_Utility_Trucks_Toy+1});                                                                                      addToCartListener("Utility Trucks Toy", itemIncrementer.Kid_Connection_Utility_Trucks_Toy, 9.99);                                                                          
                                         }}> + </button>                                    
                                     </div> 
                                     : <span className = 'add_to_cart__name'> Add to Cart </span>
            }
              ...
              cartText.Mattel_Hot_Wheels_Vehicles ? <div className = 'increment__container'> 
                                      <button className = 'minus' onClick = {() => {
                                                                                    if(itemIncrementer.Mattel_Hot_Wheels_Vehicles > 0)
                                                                                      ...
                                                                                      addToCartListener("Vehicles", itemIncrementer.Mattel_Hot_Wheels_Vehicles, 15.99);                                                                          
                                                                                    } }> - </button>
                                      <span className = 'number'> {itemIncrementer.Mattel_Hot_Wheels_Vehicles} </span>
                                      <button className = 'plus' onClick = {() => {setItemIncrementer({...itemIncrementer, Mattel_Hot_Wheels_Vehicles: itemIncrementer.Mattel_Hot_Wheels_Vehicles+1});
                                                                                  addToCartListener("Vehicles", itemIncrementer.Mattel_Hot_Wheels_Vehicles, 15.99);                                                                          
                                                                                   }}> + </button>                                    
                                     </div> 
                                     : <span className = 'add_to_cart__name'> Add to Cart </span>
              ...
              cartText.Pressman_Shark_Bite_Game ? <div className = 'increment__container'> 
                                      <button className = 'minus' onClick = {() => {
                                                                                    if(itemIncrementer.Pressman_Shark_Bite_Game > 0)
                                                                                      ...
                                                                                      addToCartListener("Shark Bite Game", itemIncrementer.Pressman_Shark_Bite_Game, 20.99);                                                                          
                                                                                    } }> - </button>
                                      <span className = 'number'> {itemIncrementer.Pressman_Shark_Bite_Game} </span>
                                      <button className = 'plus' onClick = {() => {setItemIncrementer({...itemIncrementer, Pressman_Shark_Bite_Game: itemIncrementer.Pressman_Shark_Bite_Game+1});
                                                                                  addToCartListener("Shark Bite Game", itemIncrementer.Pressman_Shark_Bite_Game, 20.99);                                                                          
                                      }}> + </button>                                    
                                     </div> 
                                     : <span className = 'add_to_cart__name'> Add to Cart </span>
              ...
              cartText.Regent_Soccerball ? <div className = 'increment__container'> 
                                      <button className = 'minus' onClick = {() => {
                                                                                    if(itemIncrementer.Regent_Soccerball > 0)
                                                                                      ...
                                                                                      addToCartListener("Soccerball", itemIncrementer.Regent_Soccerball, 12.99);                                                                          
                                                                                    } }> - </button>
                                      <span className = 'number'> {itemIncrementer.Regent_Soccerball} </span>
                                      <button className = 'plus' onClick = {() => {setItemIncrementer({...itemIncrementer, Regent_Soccerball: itemIncrementer.Regent_Soccerball+1});
                                                                                  addToCartListener("Soccerball", itemIncrementer.Regent_Soccerball, 12.99);                                                                          
                                                                                  }}> + </button>                                    
                                     </div> 
                                     : <span className = 'add_to_cart__name'> Add to Cart </span>
              ...
              cartText.Size_3T_Paw_Patrol ? <div className = 'increment__container'> 
                                      <button className = 'minus' onClick = {() => {
                                                                                    if(itemIncrementer.Size_3T_Paw_Patrol > 0)
                                                                                      ...
                                                                                      addToCartListener("Paw Patrol", itemIncrementer.Size_3T_Paw_Patrol, 12.99);                                                                          
                                                                                    } }> -</button>
                                      <span className = 'number'> {itemIncrementer.Size_3T_Paw_Patrol} </span>
                                      <button className = 'plus' onClick = {() => {setItemIncrementer({...itemIncrementer, Size_3T_Paw_Patrol: itemIncrementer.Size_3T_Paw_Patrol+1});
                                                                                  addToCartListener("Paw Patrol", itemIncrementer.Size_3T_Paw_Patrol, 12.99); }}> + </button>                                    
                                     </div> 
                                     : <span className = 'add_to_cart__name'> Add to Cart </span>
            }
          </button>
              ...
              cartText.Spark_Wooden_Puzzle_Set ? <div className = 'increment__container'> 
                                      <button className = 'minus' onClick = {() => {
                                                                                    if(itemIncrementer.Spark_Wooden_Puzzle_Set > 0)
                                                                                      ...
                                                                                      addToCartListener("Wooden Puzzle Set", itemIncrementer.Spark_Wooden_Puzzle_Set, 20.99);   } }> - </button>
                                      <span className = 'number'> {itemIncrementer.Spark_Wooden_Puzzle_Set} </span>
                                      <button className = 'plus' onClick = {() => {setItemIncrementer({...itemIncrementer, Spark_Wooden_Puzzle_Set: itemIncrementer.Spark_Wooden_Puzzle_Set+1});
                                                                                  addToCartListener("Wooden Puzzle Set", itemIncrementer.Spark_Wooden_Puzzle_Set, 20.99);   } }> - </button>
              ...
              cartText.Barbie_Pop_Star_Doll ? <div className = 'increment__container'> 
                                      <button className = 'minus' onClick = {() => {
                                                                                    if(itemIncrementer.Barbie_Pop_Star_Doll > 0)
                                                                                      ...
                                                                                      addToCartListener("Barbie Pop Star Doll", itemIncrementer.Barbie_Pop_Star_Doll, 12.99);
                                                                                      } }> - </button>
                                      <span className = 'number'> {itemIncrementer.Barbie_Pop_Star_Doll} </span>
                                      <button className = 'plus' onClick = {() => {setItemIncrementer({...itemIncrementer, Barbie_Pop_Star_Doll: itemIncrementer.Barbie_Pop_Star_Doll+1});
                                                                                  addToCartListener("Barbie Pop Star Doll", itemIncrementer.Barbie_Pop_Star_Doll, 12.99); }}> + </button>                                    
                                     </div> 
                                     : <span className = 'add_to_cart__name'> Add to Cart </span>
            }
          </button>
              ...
              cartText.Munchkin_Duck_Dunk_Bath_Toy ? <div className = 'increment__container'> 
                                      <button className = 'minus' onClick = {() => {
                                                                                    if(itemIncrementer.Munchkin_Duck_Dunk_Bath_Toy > 0)
                                                                                      ...
                                                                                      addToCartListener("Munchkin Duck Dunk Bath Toy", itemIncrementer.Munchkin_Duck_Dunk_Bath_Toy, 7.99);
                                                                                      } }> - </button>
                                      <span className = 'number'> {itemIncrementer.Munchkin_Duck_Dunk_Bath_Toy} </span>
                                      <button className = 'plus' onClick = {() => {setItemIncrementer({...itemIncrementer, Munchkin_Duck_Dunk_Bath_Toy: itemIncrementer.Munchkin_Duck_Dunk_Bath_Toy+1}); 
                                                                                addToCartListener("Munchkin Duck Dunk Bath Toy", itemIncrementer.Munchkin_Duck_Dunk_Bath_Toy, 7.99);}}> + </button>                                    
                                     </div> 
                                     : <span className = 'add_to_cart__name'> Add to Cart </span>
            }
          </button>
              ...
              cartText.Mattel_Kerplunk ? <div className = 'increment__container'> 
                                      <button className = 'minus' onClick = {() => {
                                                                                    if(itemIncrementer.Mattel_Kerplunk > 0)
                                                                                      ...
                                                                                      addToCartListener("Kerplunk", itemIncrementer.Mattel_Kerplunk, 8.99);
                                                                                      } }> - </button>
                                      <span className = 'number'> {itemIncrementer.Mattel_Kerplunk} </span>
                                      <button className = 'plus' onClick = {() => {setItemIncrementer({...itemIncrementer, Mattel_Kerplunk: itemIncrementer.Mattel_Kerplunk+1});
                                                                                  addToCartListener("Kerplunk", itemIncrementer.Mattel_Kerplunk, 8.99); }}> + </button>                                    
                                     </div> 
                                     : <span className = 'add_to_cart__name'> Add to Cart </span>
            }
          </button>
              ...
              cartText.Mattel_Kerplunk ? <div className = 'increment__container'> 
                                      <button className = 'minus' onClick = {() => {
                                                                                    if(itemIncrementer.PlayMonster_Things > 0)
                                                                                      ...
                                                                                      addToCartListener("PlayMonster Things", itemIncrementer.PlayMonster_Things, 6.99);} }> - </button>
                                      <span className = 'number'> {itemIncrementer.PlayMonster_Things} </span>
                                      <button className = 'plus' onClick = {() => {setItemIncrementer({...itemIncrementer, PlayMonster_Things: itemIncrementer.PlayMonster_Things+1}); 
                                                                                  addToCartListener("PlayMonster Things", itemIncrementer.PlayMonster_Things, 6.99)}}> + </button>                                    
                                     </div> 
                                     : <span className = 'add_to_cart__name'> Add to Cart </span>
            }
              ...
              cartText.Play_Day_Play_Balls ? <div className = 'increment__container'> 
                                      <button className = 'minus' onClick = {() => {
                                                                                    if(itemIncrementer.Play_Day_Play_Balls > 0)
                                                                                      ...
                                                                                      addToCartListener("Play Day Play Balls", itemIncrementer.Play_Day_Play_Balls, 21.99);
                                                                                      } }> - </button>
                                      <span className = 'number'> {itemIncrementer.Play_Day_Play_Balls} </span>
                                      <button className = 'plus' onClick = {() => {setItemIncrementer({...itemIncrementer, Play_Day_Play_Balls: itemIncrementer.Play_Day_Play_Balls+1});
                                        addToCartListener("Play Day Play Balls", itemIncrementer.Play_Day_Play_Balls, 21.99); }}> + </button>                                    
                                     </div> 
                                     : <span className = 'add_to_cart__name'> Add to Cart </span>
            }
          </button>
              ...
              cartText.Playmobil_School_Bus_Playset ? <div className = 'increment__container'> 
                                      <button className = 'minus' onClick = {() => {
                                                                                    if(itemIncrementer.Playmobil_School_Bus_Playset > 0)
                                                                                      ...
                                                                                      addToCartListener("School Bus Playset", itemIncrementer.Playmobil_School_Bus_Playset, 5.99);
                                                                                      } }> - </button>
                                      <span className = 'number'> {itemIncrementer.Playmobil_School_Bus_Playset} </span>
                                      <button className = 'plus' onClick = {() => {setItemIncrementer({...itemIncrementer, Playmobil_School_Bus_Playset: itemIncrementer.Playmobil_School_Bus_Playset+1});
                                       addToCartListener("School Bus Playset", itemIncrementer.Playmobil_School_Bus_Playset, 5.99); }}> + </button>                                    
                                     </div> 
                                     : <span className = 'add_to_cart__name'> Add to Cart </span>
            }
          </button>
